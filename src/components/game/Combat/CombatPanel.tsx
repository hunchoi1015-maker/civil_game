    ...
    >
      ...
      <div className="grid grid-cols-2 gap-8">
        <div className="bg-slate-800 rounded-lg p-4 text-center">
          ...
          <div className="text-3xl font-bold text-white mb-2">{cs.attackerFinalScore}</div>
          <div className="text-xs text-slate-400 space-y-1">
            <p>카드 공격력 합: {cs.attackerFinalScore - cs.attackerCombatBonus}</p>
            <p>전투 보너스: +{cs.attackerCombatBonus}</p>
          </div>
        </div>
